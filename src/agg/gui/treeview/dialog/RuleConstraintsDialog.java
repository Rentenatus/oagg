...
/**
 * This class provides a window for a user dialog. This dialog is necessary to select atomic constraints and formulas to
 * generate post application conditions for a rule.
 *
 * @author $Author: olga $
 * @version $Id
 */
...
public class RuleConstraintsDialog extends JDialog implements ActionListener {
    ...
    private List<Formula> resultFormulas;

    /**
     * Creates a rule constraints (formulas) dialog.
     *
     * @param parent The parent frame of this dialog.
     * @param r The rule for each the constraints have to be hold.
     */
     ...
     */
    private void initComponents(List<Formula> formulas) {
        ...
        for (int i = 0; i < this.allFormulas.size(); i++) {
            Formula f = this.allFormulas.get(i);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == this.allFormulaButton) {
            ...
            for (int j = 0; j < this.checkBox.size(); j++) {
                JCheckBox cb = this.checkBox.get(j);
                if (cb.isSelected()) {
                    this.resultFormulas.add(this.allFormulas.get(j));
                }
            }
