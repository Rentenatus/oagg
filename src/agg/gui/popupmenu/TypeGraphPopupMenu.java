...
/**
 * This context menu displayed on top of the type graph. Within this menu one
 * can select which level of type graph check should be applied to all other
 * graphs. The menu actions will be processed in {@link GraGraTreeView}.
 *
 * @author $Author: olga $
