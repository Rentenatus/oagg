...
public class ParserDialog extends JDialog implements ActionListener,
    ...
    public class StepPanel extends JPanel implements Runnable {
         ...
         *
         * @param step The step of the input process.
         */
 ...
 /* next und cancel button */
     ...
     *
     * @param step choose from StepPanel which graph to set
     */
...
//				fileName = gragraLoad.getFileName();
     ...
     *
     * @param e The different events frim the buttons.
     */
     ...
     *
     * @param e The event from the gragra name list.
     */
...
/**
 * $Log: ParserDialog.java,v $ Revision 1.11 2010/09/23 08:20:54 olga tuning
 *
