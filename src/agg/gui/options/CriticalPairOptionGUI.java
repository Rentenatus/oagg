 ...
 * settings for the critical pair analysis.
 *
...
//	JMenu algorithms;
     ...
     *
     * @param cpOption The algorithm options
     * @param guiOption Options for the display settings.
     * @param pOption Parser option for synchronization
     */
     ...
     *
     * @param pguiOption The GUI options for display settings.
     */
...
//		c.gridwidth = GridBagConstraints.REMAINDER;
     ...
     *
     * @param e The event from the combobox
     */
    ...
    /**
     * Receives events. In this case the method listens for a button that changes between display and algorithm setting.
     *
     ...
     *
     * @param e The events of the sliders
     */
