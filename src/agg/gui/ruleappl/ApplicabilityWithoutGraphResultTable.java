...
public class ApplicabilityWithoutGraphResultTable {
    ...
    protected final HashMap<RuleSequence, Pair<JDialog, JDialog>> sequence2table = new HashMap<RuleSequence, Pair<JDialog, JDialog>>();
    protected final HashMap<JButton, JDialog> close2table = new HashMap<JButton, JDialog>();
