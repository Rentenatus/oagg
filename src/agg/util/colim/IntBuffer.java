...
/**
 * A IntBuffer is a sequence that is very similar to a regular IntArray, except
 * that it can expand to accommodate new elements.
 * <p>
 * The implementation store elements in a contiguous linear memory space so that
 * index-based access is very quick. When an IntBuffer's originally allocated
 * memory space is exceeded, its elements are copied into a new memory space
 * that is large enough to accommodate everything.
 * <p>
 * If an insertion causes reallocation, all iterators and references are
 * invalidated; otherwise, only the iterators and references after the insertion
 * point are invalidated.
 * <p>
 * A remove invalidates all of the iterators and references after the point of
 * the remove.
 */
public class IntBuffer implements Container {
    ...
    /**
     * Construct myself to contain a specified number of elements set to a
     * particular object.
     *
     * @param size The number of elements to contain.
    ...
    public boolean equals(Object object) {
        return object instanceof IntBuffer && equals((IntBuffer) object)
    ...
    /**
     * Copy my elements into the specified array. The number of items that are
     * copied is equal to the smaller of my length and the size of the specified
     * array.
     *
     ...
     *
     * @exception com.objectspace.jgl.RuntimeException If the IntBuffer is
     * empty.
     */
    ...
    /**
     * Add an object after my last element. Returns null. This function is a
     * synonym for pushBack().
     *
    ...
    /**
     * Add a int after my last element. Returns null. This function is a synonym
     * for pushBack().
     *
     * @param object The object to add.
     */
     ...
     *
     * @param pos An iterator positioned at the element that the object will be
    ...
    /**
     * Insert a value at a particular position and return an iterator positioned
     * at the new element.
     *
     * @param pos An iterator positioned at the element that the object will be
     * inserted immediately before.
     ...
     *
     * @param index The index of the element that the object will be inserted
     * immediately before.
     * @param object The object to insert.
     * @exception java.lang.IndexOutOfBoundsException If the index is invalid.
     */
     ...
     * @param object The object to insert.
     * @exception java.lang.IndexOutOfBoundsException If the index is invalid.
     * @exception java.lang.IllegalArgumentException If the number of values is
     * negative.
     */
     ...
     *
     * @param pos The location of the element that the objects will be inserted
     * immediately before.
     * @param first An iterator positioned at the first element to insert.
     * @param last An iterator positioned immediately after the last element to
     * insert.
     */
     ...
     *
     * @param index The index of the element that the objects will be inserted
     * immediately before.
     * @param first An iterator positioned at the first element to insert.
     * @param last An iterator positioned immediately after the last element to
     * insert.
     ...
     * reallocate the elements into a storage space that is exactly the right
     * size.
     */
    ...
    /**
     * Pre-allocate enough space to hold a specified number of elements. This
     * operation does not change the value returned by size().
     *
     * @param n The amount of space to pre-allocate.
     * @exception java.lang.IllegalArgumentException If the specified size is
     * negative.
     */
    ...
    /**
     * Remove all elements that match a particular object and return the number
    ...
    /**
     * Replace all ints that match a particular object with a new value and
     * return the number of objects that were replaced.
     *
    ...
    /**
     * Return the number of objects within a particular range of indices that
    ...
    /**
     * Return the index of the first int that matches a particular value, or -1
    ...
    /**
     * Return the index of the first object within a range of indices that match
     * a particular object, or -1 if the object is not found.
     *
     * @param first The index of the first object to consider.
     * @param last The index of the last object to consider.
     * @param object The object to find.
    ...
    /**
     * Return the index of the first int within a range of indices that match a
     * particular value, or -1 if the int is not found.
     *
    ...
    /**
     * Sets the size of the IntBuffer. if the size shrinks, the extra elements
     * (at the end of the array) are lost; if the size increases, the new
