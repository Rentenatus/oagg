...
/**
 * A IntBuffer is a sequence that is very similar to a regular IntArray, except that it can expand to accommodate new
 * elements.
 * <p>
 * The implementation store elements in a contiguous linear memory space so that index-based access is very quick. When
 * an IntBuffer's originally allocated memory space is exceeded, its elements are copied into a new memory space that is
 * large enough to accommodate everything.
 * <p>
 * If an insertion causes reallocation, all iterators and references are invalidated; otherwise, only the iterators and
 * references after the insertion point are invalidated.
 * <p>
...
public class IntBuffer implements Container {
    ...
    /**
     * Copy my elements into the specified array. The number of items that are copied is equal to the smaller of my
    ...
    /**
     * Add a int after my last element. Returns null. This function is a synonym for pushBack().
     *
     * @param object The object to add.
     */
     ...
     *
     * @param pos An iterator positioned at the element before which the elements will be inserted.
     ...
     *
     * @param index The index of the element immediately before the values will be inserted.
     * @param object The object to insert.
     * @exception java.lang.IndexOutOfBoundsException If the index is invalid.
     * @exception java.lang.IllegalArgumentException If the number of values is negative.
     */
    ...
    /**
     * If my storage space is currently larger than my total number of elements, reallocate the elements into a storage
     * space that is exactly the right size.
     */
    ...
    /**
     * Pre-allocate enough space to hold a specified number of elements. This operation does not change the value
     * returned by size().
     *
    ...
    /**
     * Remove at most a given number of elements that match a particular object and return the number of objects that
     * were removed.
     *
     * @param object The object to remove.
    ...
    /**
     * Replace all ints that match a particular object with a new value and return the number of objects that were
     * replaced.
     *
    ...
    /**
     * Replace all elements within a range of indices that match a particular object with a new value and return the
    ...
    /**
     * Replace all values within a range of indices that match a particular int with a new value and return the number
     * of objects that were replaced.
     *
    ...
    /**
     * Return the index of the first object within a range of indices that match a particular object, or -1 if the
     * object is not found.
     *
     * @param first The index of the first object to consider.
     * @param last The index of the last object to consider.
    ...
    /**
     * Return the index of the first int within a range of indices that match a particular value, or -1 if the int is
     * not found.
     *
    ...
    /**
     * Sets the size of the IntBuffer. if the size shrinks, the extra elements (at the end of the array) are lost; if
     * the size increases, the new elements are set to null.
     *
