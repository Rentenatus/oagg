 ...
 * <code>BitSet</code> that is used to define which properties are supported by
 * a concrete completion strategy and which properties are actually set.
 * <p>
...
public interface CompletionPropertyBits {
    ...
    /**
     * If this bit is set to <code>true</code>, only injective completions of a
     * morphism will be found.
     */
    ...
    /**
     * If this bit is set to <code>true</code>, only matches will be found that
     * satisfy all the negative application conditions (NACs) a rule may have.
     * (This bit only applies to the completion of a match morphism.)
     */
    public static final int NAC = 3;
    /**
     * If this bit is set to <code>true</code>, only matches will be found that
     * satisfy all the positive application conditions (PACs) a rule may have.
     * (This bit only applies to the completion of a match morphism.)
     */
    public static final int PAC = 4;
    /**
     * If this bit is set to <code>true</code>, only matches will be found that
     * satisfy all the general application conditions (GACs) a rule may have.
     * (This bit only applies to the completion of a match morphism.)
     */
