...
/**
 * An implementation of morphism completion as a Constraint Satisfaction Problem (CSP). It searches for injective
 * solutions only per default, and it does not use backjumping.
 */
