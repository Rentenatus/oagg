...
public class SET_DIAGRAM extends COLIM_GRAPH {
    ...
    public int get_colimit_index(int element) {
        if (f_colimit_valid) {
            return f_colimit.item(element);
        } else {
            return f_colimit.item(f_partition.find(element));
        }
    }
    ...
    public String get_name(int node) {
        return (String) f_name.item(node);
    }
    ...
    public int source_at_edge(int edge) {
        return f_source.item(edge);
    }

    public int target_at_edge(int edge) {
        return f_target.item(edge);
    }
    ...
    public String out_morphism(int edge) {
        ...
        for (int i = source_set.lower; i <= source_set.upper;) {
            ...
            if (pos == undefined) {
                ...
                Result.append(get_element(pos + target_set.lower).toString());
            }
            i++;
            if (i <= source_set.upper) {
                Result.append(", ");
            }
        }
        Result.append("}");
