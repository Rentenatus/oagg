...
public interface Morphism extends Disposable {
    ...
    /**
     * Return an Enumeration of the graphobjects out of my source graph which are actually taking part in one of my
     * mappings. Enumeration elements are of type <code>GraphObject</code>.
     *
    ...
    /**
     * Return an Enumeration of the graphobjects out of my target graph which are actually taking part in one of my
     * mappings. Enumeration elements are of type <code>GraphObject</code>.
     *
     * @see agg.xt_basis.GraphObject
     */
    ...
    /**
     * Return an Enumeration of the inverse images of the specified object. Enumeration will be empty when the object is
     * not in codomain. Enumeration elements are of type <code>GraphObject</code>.
     *
     * @see agg.xt_basis.GraphObject
     */
