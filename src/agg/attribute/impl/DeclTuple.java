...
public class DeclTuple extends TupleObject implements AttrType, AttrMsgCode,
    ...
    /**
     * @param parent For inheritance purposes.
     */
...
//		Thread.dumpStack();
    ...
    /**
     * @param index specifies the position of my direct parent to return
     * @return parent
     */
...
//	}
     ...
     *
     * @param rootIndex Relative to the root of the inheritance tree.
     ...
     *
     * @param leafIndex Refers to this leaf.
...
//			}
     ...
     *
     * @param tuple attribute type to be compared with.
     */
