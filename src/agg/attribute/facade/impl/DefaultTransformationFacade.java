 ...
 *
 * @version $Id: DefaultTransformationFacade.java,v 1.1 2005/08/25 11:57:00 enrico Exp $
 * @author $Author: olga $
 */
public class DefaultTransformationFacade implements TransformationFacade {
    ...
    /**
     * Creates and returns a new rule context. Typically calls newContext( AttrMapping.PLAIN_MAP ) of the default
     * AttrManager.
     */
    ...
    /**
     * Returns the left side context to a rule context. Typically calls newLeftContext( ruleContext ) of the default
     * AttrManager.
     */
    ...
    /**
     * Returns the right side context to a rule context. Typically calls newRightContext( ruleContext ) of the default
     * AttrManager.
     */
    ...
    /**
     * Creates and returns a new match context to a rule context. Typically calls newContext( AttrMapping.MATCH_MAP,
     * ruleContext ) of the default AttrManager.
     */
    ...
    // Mapping:
    /**
     * Mapping between two attribute instances; The mapping is done according to the context property (rule/match) and
     * is integrated into the context;
     *
     ...
     * one (next()). If the mapping context is that of a match, a match on the attributes is tried. If this fails,
     * "null" is returned.
     */
    ...
    /**
     * Discard mapping; Removes variable assignments made by a mapping from its context and dissolves the connection
    ...
    /**
     * Getting the number of variables declared by an instance which have no value assigned to them yet. Each variable
