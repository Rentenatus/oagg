 ...
 *
 * @version $Id: DefaultInformationFacade.java,v 1.1 2005/08/25 11:57:00 enrico Exp $
 * @author $Author: olga $
 */
public class DefaultInformationFacade implements InformationFacade {
     ...
     *
     * @param tuple The attribute tuple (type or instance) to observe.
     ...
     *
     * @param tuple The attribute tuple (type or instance) observed.
     * @param attrObs The attribute observer to be registered.
     */
