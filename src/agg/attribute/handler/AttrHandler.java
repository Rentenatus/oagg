...
public interface AttrHandler extends Serializable {
     ...
     * @exception AttrHandlerException When the type cannot be found in the
     * handler.
     */
     ...
     * @exception AttrHandlerException When the expression String cannot be a
     * representation of an expression of the given type.
     */
     ...
     * @param type A handle of one of the types created by 'newHandlerType()'.
     * @return The handle for a newly created expression or...
     * @exception AttrHandlerException When the instance is not of the required
     * type.
     */
