...
//		COUNTER--;
    ...
    /**
     * Returns the member index at the specified slot; If the boolean parameter is true, the slot is interpreted wrt the
     * container with all members, otherwise wrt the container with the visible members only.
     */
    ...
    /**
     * Moves the member at "srcSlot" to "destSlot", inserting-wise. The slots refer to the container with all members.
     * The slot order for visible members is adapted accordingly.
     */
    ...
    /**
     * Returns the slot for visible members containing the same index as the specified slot for all members, or
     * 'HIDDEN'.
     */
