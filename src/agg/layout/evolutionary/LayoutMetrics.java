...
public class LayoutMetrics {
     ...
     *
     * @param arcs Kanten die auf eine Ueberschneidung zu pruefen sind
...
//		Point2D source, target;
     ...
     *
     * @param nodes Knoten die untersucht werden sollen
     * @param mark wenn true, sollen die EdNodes(bzw.Layoutnodes), bei denen
...
//		Rectangle2D rect1, rect2;
     ...
     *
     * @param arcs Kanten deren Laengen untersucht werden soll
     ...
     *
     * @param oldednodes Knoten vor der aktuellen Transformation
     * @param newednodes Knoten nach der aktuellen Transformation und dem
     * erneuerten Layout.
     */
