...
//				System.out.println(">>> Concurrent rule total creation time : "+(System.currentTimeMillis()-t0) + "ms   ");
    ...
    public List<EdRule> makeConcurrentRuleOfRuleSeqForward(
        ...
        if (seq != null) {
            ...
            final List<ConcurrentRule> crs = BaseFactory.theFactory()
    ...
    public EdRule makeParallelRuleOfRules(
        ...
        if (!rules.isEmpty()) {
            ...
            final ParallelRule parallelRule = new ParallelRule(this.typeSet.getBasisTypeSet(), rules);
    ...
    public EdRule makeParallelRuleOfTwoRules(
        ...
        final ParallelRule parallelRule = new ParallelRule(this.typeSet.getBasisTypeSet(), r1, r2);
...
//	}
     ...
     *
     * @param pname name of a layout pattern
     * @param pType type of a layout pattern ("edge" only)
     * @param type type of an edge which will use this layout pattern
     * @param offsetType offset type which can be 'x' or 'y'
     * @param offset value which can be -1, 1 or 0.
     */
     ...
     * @param pType type of a layout pattern ("edge" only)
     * @param type type of an edge which will use this layout pattern
     * @param frozen allow to change (X,Y) position
     */
    public void createLayoutPattern(String pName, String pType, Type type,
            boolean frozen) {
