                ...
                <xsl:for-each select="Morphism/Mapping">
                    ...
                    <xsl:if test="../../Graph[1]/Node[@ID=$var_orig]">
                        ...
                        <xsl:call-template name="node_attr">
                            <xsl:with-param name="var_orig">
                                <xsl:value-of select="$var_orig"/>
                            </xsl:with-param>
                            <xsl:with-param name="var_image">
                                <xsl:value-of select="$var_image"/>
                            </xsl:with-param>							
                        </xsl:call-template>
                    </xsl:if>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="../../Morphism/Mapping[@image=$var_target]">
                                            ...
                                            <xsl:call-template name="edge_condition">
                                                ...
                                                <xsl:with-param name="par_source">
                                                    <xsl:value-of select="$orig_source"/>
                                                </xsl:with-param>
                                                <xsl:with-param name="par_target">
                                                    <xsl:value-of select="$orig_target"/>
                                                </xsl:with-param>
                                                <xsl:with-param name="par_type">
                                                    <xsl:value-of select="$var_type"/>
                                                </xsl:with-param>
